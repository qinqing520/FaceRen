  ...
  <div>
    <el-card style="margin-top: 0.15rem;">
      <el-row justify="space-between"
              ...
              class="oneRow">
        <el-col :span="12">
          <span> IP: <input placeholder="请输入IP"
                   v-model="seekIP" /></span>
          <!-- 筛选按钮 -->
        ...
        <el-col :span="5"
                v-if="listdata">
          <span>在线设备: {{listdata.length}}</span>
          <span>设备总数: {{listdata.length}}</span> </el-col>
      </el-row>
      <el-row class="twoRow">
        <!-- 添加按钮 -->
        <span @click="isAddDevice"><img src="../../assets/img/add202.png" /></span>
        <el-dialog title="添加设备信息"
                   :visible.sync="addDevice.dialogVisible"
                   width="30%">
          <div class="basicMessage">
            <div><b>公司:</b>
              <em>
                <el-input placeholder="请输入选择所属的公司"
                          v-model="addDevice.CompanyName"></el-input>
              </em>
            </div>
            <div><b>设备类型:</b>
              <em>
                <el-select v-model="addDevice.DeviceType"
                           slot="prepend"
                           placeholder="请输入设备类型">
                  <el-option label="面板机"
                             value="facePlate">
            ...
            <div><b>IP/域名:</b>
              <em>
                <el-input placeholder="请输入IP/域名"
                          v-model="addDevice.DeviceIp"></el-input>
              </em>
            </div>
            <div><b>序列号:</b>
              <em>
                <el-input placeholder="请输入序列号"
            ...
            <div><b>密码:</b>
              <em>
                <el-input placeholder="请输入密码"
                          v-model="addDevice.DevicePassword"
                          type="password"></el-input>
              </em>
            </div>
            <div><b>协议类型:</b>
              <em>
                <el-select v-model="addDevice.ProtocolType"
                           slot="prepend"
                           placeholder="请输入设备类型">
                  <el-option label="私有协议"
                             value="private">
                  </el-option>
                  <el-option label="rtsp协议"
                             value="rtsp">
                  </el-option>
                </el-select>
              </em>
          ...
          <span slot="footer"
                class="dialog-footer">
            <el-button @click="addDevice.dialogVisible = false">取 消</el-button>
